      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl px-8 py-10 space-y-7">
        ...
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
            ...
            <path d="M5.84 14.09a7.12 7.12 0 0 1 0-4.17V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z" fill="#fff" />
        ...
        <p className="text-center text-xs text-gray-400 leading-relaxed">
          ...
          <span className="font-medium text-gray-500">@topnetworks.co</span>{" "}
          and{" "}
